  ...
  debut: // etiquete goto en default
      ...
      switch(choix){
        case 1:
              ...
              MatriceDAdjacence mgo = creerMatAdjGO(); LN
              afficheMatriceAdjacence(mgo); LN
              afficheArcs(mgo); LN
        ...
        case 2:
              ...
              MatriceDAdjacence mgno = creerMatAdjGNO(); LN
              afficheMatriceAdjacence(mgno); LN
              afficheArete(mgno); LN
        break;
        default:
  ...
  debut:
      ...
      switch(choix){
        case 1:
              ...
              MatriceDIncidence mgo = creerMatIncidGO(); LN
              afficheMatriceIncidence(mgo); LN
              afficheArcMatriceIncidence(mgo); LN
        ...
        case 2:
              ...
              MatriceDIncidence mgno = creerMatIncidGNO(); LN
              afficheMatriceIncidence(mgno); LN
              afficheAreteMatriceIncidence(mgno); LN
...
void mesListesDadjacence(){
  ...
  afficherListeAdj(li);
  MatriceDAdjacence m = getMatriceDAdjacence(li); LN
...
Graphe* creerGraphe(int numSommet, int numLien){
	...
	graphe->arcs = (ArcValue*)malloc(numLien * sizeof(ArcValue));
...
void grapheEnLiaison(){
    ...
    int X, U;
    printf("\nSaisir le nombre de sommet |X|: "); scanf("%d", &X);
    printf("Saisir le nombre de liaisons |U|: "); scanf("%d", &U);

    Graphe *graphe = creerGraphe(X, U);
    saisirGraphe(graphe); LN
